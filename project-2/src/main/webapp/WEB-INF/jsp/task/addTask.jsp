...
<body>
	...
	<table border="1">
		<tr>
			<td>팀 이름을 입력하세요</td>
			<td><a href="#" class="showMask">업무 추가</a></td>
		</tr>
		<tr>
			<td><input type="checkbox" value="finished" /> ㅇㅇ업무 하기</td>
		</tr>
			...
			<div class="window">
				<center>
					<table>
						...
						<tr>
							<td><input type="submit" value="완료" /> <input type="button"
								href="#" class="close" value="취소" /></td>
						</tr>
