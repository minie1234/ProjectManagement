...
<!-- Sidebar -->
    ...
    <div style="padding : 30px;">
      <div class="form-group" style="padding : 10px; background : #ffffff;">
        <label>제목  :  </label>
      ...
      <div class="form-group" style="padding : 10px;" >
          <input class ="w3-bar-item w3-button w3-theme-l1" type="button" value="수정" onclick='location.href="/project-2/file/post/${file.fileNo}"'>
          <form:form action="/project-2/file/post/${file.fileNo}" method="DELETE">
              <input class = "w3-bar-item w3-button w3-theme-l1" type="submit" value="삭제">
          </form:form>
      </div>
    </div>
    </section>
