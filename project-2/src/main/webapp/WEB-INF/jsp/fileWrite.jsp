    ...
    <div style="padding : 30px;">
        <form method="POST" action="/project-2/file/post" enctype="multipart/form-data">
         <div class="form-group" style="padding : 10px; background : #ffffff;">
          ...
          <div class="form-group" style="padding : 10px; background : #ffffff;">
          <label>첨부파일  :  </label>
         	 	<input type="file" name="report" class="form-control" class="w3-bar-item w3-button w3-hide-small w3-hover-white" >
        	 <br/><br/>
          </div>
          <button type="submit" class ="w3-bar-item w3-button w3-theme-l1">작성</button>
        </form>
    </div>
    </section>
</body>
